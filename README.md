...
The repo currently has 389 tests, all green across 14 modules.
...
389 tests, 0 failures. The analyzer's dogfood pass over the entire
...
| `@derive(Json)` decoder (compile-time)   | runtime + KSP decoder; Secret roundtrip is Phase-4 follow-up | shipped       |
